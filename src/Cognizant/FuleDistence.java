/*
 ...
 The program should ask the user to enter the quantity of diesel to fill up the tank and the distance covered till the 
...
public class FuleDistence {
    void result(float fuel,float distence)
    {
        System.out.println((float)((fuel/distence)*100));
        System.out.println((float)(((0.6214)*distence)/(fuel*0.2642)));
    ...
    public static void main(String[] args) {
      ...
      //  int distence=sc.nextInt();
        FuleDistence obj = new FuleDistence();
        obj.result(20, 150);
    }    
}
